...
def predict(image_path):
    ...
    node_id_to_name = load(os.path.join(MODEL_DIR, 'imagenet_2012_challenge_label_map_proto.pbtxt'), os.path.join(MODEL_DIR, 'imagenet_synset_to_human_label_map.txt'))
...
if __name__ == '__main__':
    ...
    pr_results, pr_pr = predict(image_path)
